...
public class EmailMessageReceiving {
	...
	public static void sendMailWithFIle(String subject,String text,String mailServer, String directionFrom, ArrayList directionsTo, String pathFileToSend, Receiving rec){
		if(rec != null)
